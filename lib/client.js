window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh$1 = {
			...
			"reason.central-subagent-routing": "alpha.1 没有全局子代理启动路由接口。",
			"reason.packaged-preset-roots": "alpha.1 不支持插件提供额外 preset root。",
			"reason.tool-owner-suppression": "alpha.1 没有工具所有者或来源抑制接口。",
		...
		const en$1 = {
			...
			"reason.central-subagent-routing": "alpha.1 exposes no global Subagent start-routing seam.",
			"reason.packaged-preset-roots": "alpha.1 exposes no plugin-owned preset root.",
			"reason.tool-owner-suppression": "alpha.1 exposes no tool owner or provenance suppression seam.",
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+fixtures+alpha1+tarballs+dsh-llm-providers-ui-0.1.1-b2c0da03e_0597bc84eda2af867825632603dd6cf4/node_modules/dsh-llm-providers-ui/lib/order.js
