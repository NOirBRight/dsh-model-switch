window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function ComposerPicker({ locked, available, directory: state, directoryFace, t, draft, onDraftChange, embedded, tone, externalTargets = [], externalTargetsLabel, externalSelection, onExternalTargetChange, resolveInteractionOperations }) {
		...
		function PlanReviewState({ matched, review, available, snapshot, directoryFace, t, resolveInteractionOperations }) {
			const { getDirectorySnapshot, load, select } = directoryFace;
