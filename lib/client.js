	...
	factory: (require) => {
		...
		*/
		...
		function PlanReviewCard(props) {
			...
			const remoteUnavailable = (0, react.useSyncExternalStore)(props.subscribeMainDefaults, props.getMainDefaultsSnapshot).mode === "memory";
		...
		function PlanReviewState({ matched, review, available, providerLock, agentLocked, lockFailed, remoteUnavailable, directory, t, resolveInteractionOperations, roleOf }) {
			...
			const remoteBlock = remoteUnavailable && execution !== void 0 && (snapshot.current === null || execution.provider !== snapshot.current.provider || execution.model !== snapshot.current.model || execution.reasoningEffort !== snapshot.current.reasoningEffort);
			const executionAllowed = execution !== void 0 && !remoteBlock && runtimeChoiceAllowed(providerLock, agentLocked, execution.provider, snapshot.current?.provider, isAgentRole(roleOf?.(execution.provider)));
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								role: "status",
								children: action.error ?? (remoteBlock ? t("settings.remoteUnavailable") : null)
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
