window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		var PickerSeatBoundary = class extends react.Component {
			state = { message: null };
			...
			render() {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					children: `Model picker error: ${this.state.message}`
				});
			}
		};
		//#endregion
		...
		function ModelSeatEntry(props) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PickerSeatBoundary, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ModelSeat, { ...props }) });
		}
