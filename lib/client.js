		...
		var PickerGuard = class extends react.Component {
			...
			render() {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: this.props.errorLabel(this.state.message) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
						type: "button",
						variant: "outline",
						onClick: () => {
		...
		var PickerSeatBoundary = class extends react.Component {
			...
			render() {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					children: this.props.errorLabel(this.state.message)
				});
			}
		};
		//#endregion
